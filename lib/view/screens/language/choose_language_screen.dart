        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                getTranslated('choose_the_language', context).toString(),
            ...
            Consumer<LanguageProvider>(
                builder: (context, languageProvider, child) => Padding(
                      ...
                      child: CustomButton(
                        btnTxt: getTranslated('save', context).toString(),
                        onTap: () {
                          if(languageProvider.languages.length > 0 && languageProvider.selectIndex != -1) {
                            ...
                            showCustomSnackBar(getTranslated('select_a_language', context).toString(), context);
                          }
                        },
                      ),
                    )),
