                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 10),
                      Text(
                        getTranslated('my_profile', context).toString(),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            getTranslated('theme_style', context).toString(),
                            style: Theme.of(context)
                                .textTheme
                                .headline3
                      ...
                      SizedBox(height: 20),
                      ProfileButton(icon: Icons.privacy_tip, title: getTranslated('privacy_policy', context).toString(), onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => HtmlViewerScreen(isPrivacyPolicy: true)));
                      }),
                      SizedBox(height: 10),
                      ProfileButton(icon: Icons.list, title: getTranslated('terms_and_condition', context).toString(), onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => HtmlViewerScreen(isPrivacyPolicy: false)));
                      }),
                      SizedBox(height: 10),
                      ProfileButton(icon: Icons.logout, title: getTranslated('logout', context).toString(), onTap: () {
