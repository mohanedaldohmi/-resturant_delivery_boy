...
class DeliveryDialog extends StatelessWidget {
  ...
  DeliveryDialog({required this.onTap, required this.totalPrice, required this.orderModel, required this.index});
          ...
          clipBehavior: Clip.none, children: [
            Column(
              ...
              children: [
                ...
                Center(
                    child: Text(
                  getTranslated('do_you_collect_money', context).toString(),
                ...
                Row(
                  children: [
                    Expanded(
                        child: CustomButton(
                      btnTxt: getTranslated('no', context).toString(),
                      isShowBorder: true,
                      onTap: () {
                    ...
                    Expanded(
                      ...
                      builder: (context, order, child) {
                        return !order.isLoading ? CustomButton(
                          btnTxt: getTranslated('yes', context).toString(),
                          onTap: () {
