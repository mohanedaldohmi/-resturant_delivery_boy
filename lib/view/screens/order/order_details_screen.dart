...
class OrderDetailsScreen extends StatelessWidget {
  ...
  final int index;
  OrderDetailsScreen({required this.orderModel, required this.index});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          getTranslated('order_details', context).toString(),
                ...
                children: [
                    ...
                    child: ListView(
                      ...
                      children: [
                          ...
                          Expanded(
                            child: Row(
                              ...
                              children: [
                                ...
                                orderModel.deliveryTime == null ? Text(DateConverter.isoStringToLocalDateOnly(orderModel.createdAt.toString()),
                                  style: rubikRegular.copyWith(color: Theme.of(context).highlightColor),
                                ) : Text(
                                  DateConverter.deliveryDateAndTimeToDate(orderModel.deliveryDate.toString(), orderModel.deliveryTime.toString())
                                  ,style: rubikRegular.copyWith(color: Theme.of(context).highlightColor),
                                ),
                              ],
                            ),
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Padding(
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(getTranslated('customer', context).toString(), style: rubikRegular.copyWith(
                            ...
                            orderModel.orderStatus == 'processing' || orderModel.orderStatus == 'out_for_delivery'
                                ? Row(children: [
                                    Text('${getTranslated('payment_status', context)}:',
                                        style: rubikRegular.copyWith(color: Theme.of(context).highlightColor)),
                                    SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                    Text(getTranslated('${orderModel.paymentStatus}', context).toString(),
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Row(
                                      children: [
                                        Expanded(
                                          child: Text(
                                            order.orderDetails![index].productDetails!.name.toString(),
                                            style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).highlightColor),
                                            maxLines: 2,
                                            overflow: TextOverflow.ellipsis,
                                          ),
                                        ),
                                        Text(getTranslated('amount', context).toString(), style: rubikRegular.copyWith(color: Theme.of(context).highlightColor)),
                                      ],
                                    ),
                                    ...
                                    Row(children: [
                                      ...
                                      SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                      Text(
                                        '${getTranslated('order_at', context)}${DateConverter.isoStringToLocalDateOnly(order.orderDetails![index].updatedAt.toString())}',
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, i) {
                                          return Padding(
                                            ...
                                            child: Row(children: [
                                              Text(_addOns[i].name.toString(), style: rubikRegular.copyWith(color: Theme.of(context).highlightColor)),
                                              SizedBox(width: 2),
                                              Text(
                        ...
                        (orderModel.orderNote != null && orderModel.orderNote!.isNotEmpty) ? Container(
                          ...
                          child: Text(orderModel.orderNote.toString(), style: rubikRegular.copyWith(color: Theme.of(context).hintColor)),
                        ) : SizedBox(),

                        // Total
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(getTranslated('items_price', context).toString().toString(), style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                          Text(PriceConverter.convertPrice(context, _itemsPrice), style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                        ]),
                        SizedBox(height: 10),

                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(getTranslated('tax', context).toString(),
                              style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).highlightColor)),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(getTranslated('addons', context).toString(),
                              style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).highlightColor)),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(getTranslated('subtotal', context).toString(),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(getTranslated('discount', context).toString(),
                              style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).highlightColor)),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(getTranslated('coupon_discount', context).toString(),
                              style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).highlightColor)),
                          Text(
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(getTranslated('delivery_fee', context).toString(),
                              style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).highlightColor)),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(getTranslated('total_amount', context).toString(),
                        ...
                        orderModel.orderStatus == 'processing' || orderModel.orderStatus == 'out_for_delivery'
                            ? CustomButton(
                            btnTxt: getTranslated('direction', context).toString(),
                            onTap: () {
                              Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high).then((position) {
                                MapUtils.openMap(
                                    double.parse(orderModel.deliveryAddress!.latitude.toString()) ?? 23.8103,
                                    double.parse(orderModel.deliveryAddress!.longitude.toString()) ?? 90.4125,
                  ...
                  orderModel.orderStatus != 'delivered' ? Center(
                    child: Container(
                      ...
                      child: CustomButton(btnTxt: getTranslated('chat_with_customer', context).toString(), onTap: (){
                    ...
                    child: Transform.rotate(
                      ...
                      child: Directionality(
                        ...
                        child: SliderButton(
                          ...
                          ///Put label over here
                          label: Text(
                            getTranslated('swip_to_deliver_order', context).toString(),
                          ...
                          baseColor: Theme.of(context).primaryColor, child: Text(''),
                        ),
                      ),
                    ),
                  )
                    ...
                    child: Transform.rotate(
                      ...
                      child: Directionality(
                        ...
                        child: SliderButton(child : Text(''),
                          ...
                          ///Put label over here
                          label: Text(
                            getTranslated('swip_to_confirm_order', context).toString(),
                            style: Theme.of(context).textTheme.headline3?.copyWith(color: Theme.of(context).primaryColor),
                          ),
                          dismissThresholds: 0.5,
                          dismissible: false,
