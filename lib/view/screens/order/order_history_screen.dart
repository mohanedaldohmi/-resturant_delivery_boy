  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          getTranslated('order_history', context).toString(),
      ...
      body: Consumer<OrderProvider>(
        builder: (context, order, child) => order.allOrderHistory != null ? order.allOrderHistory!.length > 0
                ...
                child: order.allOrderHistory!.length > 0
                                      ...
                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(getTranslated('amount', context).toString(), style: rubikRegular.copyWith(color: Theme.of(context).textTheme.bodyText1?.color)),
                                          ],
                                        ),
                                        ...
                                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                          Row(
                                            children: [
                                              Text(getTranslated('status', context).toString(),
                                                  style: rubikRegular.copyWith(color: Theme.of(context).textTheme.bodyText1?.color)),
                                              Text(getTranslated('${order.allOrderHistory![index].orderStatus}', context).toString(),
                                                  style: rubikMedium.copyWith(color: Theme.of(context).primaryColor)),
                                            ],
                                          ),
                                          Text(PriceConverter.convertPrice(context, orde?.allOrderHistory[index]?.orderAmount),
                                              style: rubikMedium.copyWith(color: Theme.of(context).primaryColor)),
                                        ]),
                                        ...
                                        Row(children: [
                                          ...
                                          Text(
                                            '${getTranslated('order_at', context)}${DateConverter.isoStringToLocalDateOnly(order.allOrderHistory![index].updatedAt.toString())}',
                    ...
                    : Center(
                        child: Padding(
                          ...
                          child: Text(
                            getTranslated('no_data_found', context).toString(),
          ...
          getTranslated('no_history_available', context).toString(),
