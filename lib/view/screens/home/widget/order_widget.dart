...
class OrderWidget extends StatelessWidget {
  ...
  final int index;
  OrderWidget({required this.orderModel, required this.index});
        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Text(
                    getTranslated('order_id', context).toString(),
                  ...
                  Provider.of<LocalizationProvider>(context).isLtr
                      ? Positioned(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              getTranslated('${orderModel.orderStatus}', context).toString(),
          ...
          Row(
            children: [
              Expanded(
                  child: CustomButton(
                btnTxt: getTranslated('view_details', context).toString(),
                onTap: () {
