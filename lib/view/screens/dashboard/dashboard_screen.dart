    ...
    return WillPopScope(
      ...
      child: Scaffold(
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            _barItem(Icons.home, getTranslated('home', context).toString(), 0),
            _barItem(Icons.history, getTranslated('order_history', context).toString(), 1),
            _barItem(Icons.person, getTranslated('profile', context).toString(), 2),
          ],
          onTap: (int index) {
            _setPage(index);
          },
