...
class OrderProvider with ChangeNotifier {
  ...
  Future<ResponseModel> updateOrderStatus({String? token, int? orderId, String ?status, required int index}) async {
    _isLoading = true;
    _feedbackMessage = '';
    notifyListeners();
  ...
  Future<Future<List<OrderModel>?>> refresh(BuildContext context) async{
